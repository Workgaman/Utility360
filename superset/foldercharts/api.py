...
from superset.foldercharts.commands.bulk_delete import BulkDeleteChartCommand
from superset.foldercharts.commands.create import CreateChartCommand
from superset.foldercharts.commands.delete import DeleteChartCommand
...
from superset.foldercharts.commands.update import UpdateChartCommand
from superset.foldercharts.dao import ChartDAO
from superset.foldercharts.filters import ChartFilter, ChartNameOrDescriptionFilter
from superset.foldercharts.schemas import (
    CHART_DATA_SCHEMAS,
...
class FolderChartRestApi(BaseSupersetModelRestApi):
    datamodel = SQLAInterface(Slice)

    resource_name = "folderview"
    ...
    def data(self) -> Response:
        ...
        post:
          ...
          requestBody:
            ...
            content:
              application/json:
                schema:
                  $ref: "#/components/schemas/FolderChartDataQueryContextSchema"
          responses:
            200:
              ...
              content:
                application/json:
                  schema:
                    $ref: "#/components/schemas/FolderChartDataResponseSchema"
            400:
              $ref: '#/components/responses/400'
            500:
              $ref: '#/components/responses/500'
        ...
        if not request.is_json:
            return self.response_400(message="Request is not JSON")
        try:
            query_context, errors = FolderChartDataQueryContextSchema().load(request.json)
            if errors:
