...
class FolderChartDataAdhocMetricSchema(Schema):
    """
...
class FolderChartDataAggregateOptionsSchema(ChartDataPostProcessingOperationOptionsSchema):
    """
...
class FolderChartDataRollingOptionsSchema(ChartDataPostProcessingOperationOptionsSchema):
    """
...
class FolderChartDataSelectOptionsSchema(ChartDataPostProcessingOperationOptionsSchema):
    """
...
class FolderChartDataSortOptionsSchema(ChartDataPostProcessingOperationOptionsSchema):
    """
    Sort operation config.
    """
...
class FolderChartDataPivotOptionsSchema(ChartDataPostProcessingOperationOptionsSchema):
    """
...
class FolderChartDataGeohashDecodeOptionsSchema(
...
class FolderChartDataGeohashEncodeOptionsSchema(
    ChartDataPostProcessingOperationOptionsSchema
):
    """
...
class FolderChartDataGeodeticParseOptionsSchema(
    ChartDataPostProcessingOperationOptionsSchema
):
    """
...
class ChartDataQueryObjectSchema(Schema):
    ...
    metrics = fields.List(
        ...
        "`FolderChartDataAdhocMetricSchema` for the structure of ad-hoc metrics.",
    )
...
class FolderChartDataDatasourceSchema(Schema):
...
class FolderChartDataQueryContextSchema(Schema):
    datasource = fields.Nested(FolderChartDataDatasourceSchema)
...
class FolderChartDataResponseResult(Schema):
...
class FolderChartDataResponseSchema(Schema):
    result = fields.List(
        fields.Nested(FolderChartDataResponseResult),
        description="A list of results for each corresponding query in the request.",
    )


CHART_DATA_SCHEMAS = (
    FolderChartDataQueryContextSchema,
    FolderChartDataResponseSchema,
    ...
    FolderChartDataAdhocMetricSchema,
    FolderChartDataAggregateOptionsSchema,
    FolderChartDataPivotOptionsSchema,
    FolderChartDataRollingOptionsSchema,
    FolderChartDataSelectOptionsSchema,
    FolderChartDataSortOptionsSchema,
    FolderChartDataGeohashDecodeOptionsSchema,
    FolderChartDataGeohashEncodeOptionsSchema,
    FolderChartDataGeodeticParseOptionsSchema,
)
