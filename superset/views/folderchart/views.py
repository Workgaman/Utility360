...
from superset.views.folderchart.mixin import SliceMixin


class FolderSliceModelView(
    SliceMixin, SupersetModelView, DeleteMixin
):  # pylint: disable=too-many-ancestors
    route_base = "/folderview"
...
class FolderSliceAsync(FolderSliceModelView):  # pylint: disable=too-many-ancestors
